...
public final class ActivityHistoricoBinding implements ViewBinding {
  ...
  @NonNull
  public final ListView lvHistorico;

  private ActivityHistoricoBinding(@NonNull FrameLayout rootView, @NonNull ListView lvHistorico) {
  ...
  public static ActivityHistoricoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.lvHistorico;
      ListView lvHistorico = ViewBindings.findChildViewById(rootView, id);
      if (lvHistorico == null) {
        break missingId;
      }

      return new ActivityHistoricoBinding((FrameLayout) rootView, lvHistorico);
    }
